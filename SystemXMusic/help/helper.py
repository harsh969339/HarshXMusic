...
```
 єxᴧϻᴘʟє : @RadhaaMusicBot @Its_ydv_vikky Hii
```
...
'''
    HELP_ABOUT = '''
**─────────────────────────
│ ᴡєʟᴄσϻє ᴛσ ˹[˹sʏsᴛᴇᴍ ʙᴏᴛs˼](https://t.me/APNA_SYSTEM)˼ ʙσᴛ sᴛᴧᴛυs │
─────────────────────────
...
─────────────────────────
❖ υᴘᴅᴧᴛєs ᴄʜᴧηηєʟ ➥ [˹sʏsᴛᴇᴍ ʙᴏᴛs˼](https://t.me/APNA_SYSTEM)
❖ sυᴘᴘσʀᴛ ᴄʜᴧᴛ ➥ [˹˹sʏsᴛᴇᴍ ʙᴏᴛs˼](https://t.me/Exampurss)
❖ ʙᴏᴛ σᴡηєʀ ➥ [˹sʏsᴛᴇᴍ ʙᴏᴛs˼](https://t.me/APNA_SYSTEM)
