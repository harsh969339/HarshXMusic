...
#BOT FILE NAME
from SystemXMusic import app as app
from SystemXMusic.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="• ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ •",
            url=f"https://t.me/Jio_savan_music_bot?startgroup=true",
        ),
    ],
]
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "SystemXMusic/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "SystemXMusic/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("SystemXMusic/assets/cppic.png")
