...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("SystemXMusic/assets/font.ttf", 32)
        regular_font = ImageFont.truetype("SystemXMusic/assets/font2.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "SystemXMusic/assets/play_icons.png"
    ...
    # Add "SYSTEM BOTS" top-right (default font)
    font = ImageFont.truetype("SystemXMusic/assets/font.ttf", 28)  # 
    text = "SYSTEM NETWORK"
